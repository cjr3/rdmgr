...
class Client extends React.PureComponent {
    constructor(props) {
        ...
        this.state = {
            currentApp:this.Applications.CC,
            visible:false,
            ConfigShown:false,
            ChatShown:false,
            ...
            RecordUpdateTypes:{},
            UnreadMessageCount:ChatController.GetUnreadMessageCount(),
            Peers:Object.assign({}, DataController.getPeers())
        };
