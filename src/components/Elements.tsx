...
export const IconBoxLeft:any = require('images/icons/box-leftside.png');
export const IconBoxRight:any = require('images/icons/box-rightside.png');
export const IconBoxTop:any = require('images/icons/box-topside.png');
export const IconBoxBottom:any = require('images/icons/box-bottomside.png');
